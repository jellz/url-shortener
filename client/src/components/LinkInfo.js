      ...
      <div>
        {!this.state.link && (
          <Message error icon>
            ...
            <p>
              Are you sure you have the correct link? jlz.fun links are
              typically 1-8 characters long and are case-sensitive
            </p>
          </Message>
        )}
        ...
        {this.state.link && (
          <Table definition>
            ...
            <Table.Row>
              ...
              <Table.Cell>
                {new Date(this.state.link.createdAt).toUTCString()}
              </Table.Cell>
            </Table.Row>
            <Table.Row>
              <Table.Cell>Redirect link</Table.Cell>
              <Table.Cell>
                <a href={this.state.link.long}>{this.state.link.long}</a>
              </Table.Cell>
            </Table.Row>
            <Table.Row>
